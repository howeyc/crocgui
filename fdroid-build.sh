...
curl -Lso go.tar.gz https://go.dev/dl/go1.24.1.linux-amd64.tar.gz
echo "cb2396bae64183cdccf81a9a6df0aea3bce9511fc21469fb89a0c00470088073 go.tar.gz" | sha256sum -c -
